...
export const SELLER_PROFILES_REQUEST = "SELLER_PROFILES_REQUEST";
export const SELLER_PROFILES_SUCCESS = "SELLER_PROFILES_SUCCESS";
export const SELLER_PROFILES_FAIL = "SELLER_PROFILES_FAIL";
export const SELLER_PROFILES_RESET = "SELLER_PROFILES_RESET";
...
export const PROFILE_BY_USER_REQUEST = "PROFILE_BY_USER_REQUEST";
export const PROFILE_BY_USER_SUCCESS = "PROFILE_BY_USER_SUCCESS";
export const PROFILE_BY_USER_FAIL = "PROFILE_BY_USER_FAIL";

export const LATEST_SELLERS_LIST_REQUEST = "LATEST_SELLERS_LIST_REQUEST";
export const LATEST_SELLERS_LIST_SUCCESS = "LATEST_SELLERS_LIST_SUCCESS";
export const LATEST_SELLERS_LIST_FAIL = "LATEST_SELLERS_LIST_FAIL";
